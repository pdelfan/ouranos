...
export default function Refetch(props: Props) {
  ...
  return (
    <Button
      ...
      className={`z-40 p-3 rounded-full fixed bottom-28 sm:bottom-24 md:bottom-8 ml-3 border-2 border-neutral-300 bg-white hover:bg-neutral-50 hover:-rotate-180 ${
